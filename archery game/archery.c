...
void counting()
{
printf(str,"No of Arrows: %d",count);
...
display_string(180,350,"MANGALORE INSTITUTE OF TECHNOLOGY AND ENGINEERING COLLEGE",1);
...
glutAddMenuEntry("A ASHITHA",9);
glutAddMenuEntry("ANANYA HARISH SHETTY",10);
glutCreateMenu(game);
